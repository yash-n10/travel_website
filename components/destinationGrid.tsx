        ...
        <div className="grid grid-cols-1 gap-4 md:hidden">
          <Link href={`/tours?country=Karnataka`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway1.jpg" alt="Karnataka " fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
          ...
          <Link href={`/tours?country=Andaman`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway2.jpg" alt="Andaman" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
              <div className="absolute bottom-6 left-6">
          ...
          <Link href={`/tours?country=Kerala`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway3.jpg" alt="Kerala" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
              <div className="absolute bottom-6 left-6">
          ...
          <Link href={`/tours?country=Himachal Pradesh`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway4.jpg" alt="Himachal Pradesh" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
              <div className="absolute bottom-6 left-6">
          ...
          <Link href={`/tours?country=Ladakh`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway5.jpg" alt="Ladakh" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
              <div className="absolute bottom-6 left-6">
          ...
          <Link href={`/tours?country=Uttarakhand`}>
            <Card className="relative overflow-hidden rounded-lg h-[200px] group cursor-pointer">
              <Image src="/images/pack_and_gateway6.jpg" alt="Uttarakhand" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
              <div className="absolute bottom-6 left-6">
        ...
        <div className="hidden md:flex gap-4 h-[400px]">
          ...
          <div className="flex flex-col gap-4 w-1/3">
            ...
            <Link href={`/tours?country=Ladakh`} className="h-1/2">
              <Card className="relative overflow-hidden rounded-lg h-full group cursor-pointer">
                <Image src="/images/pack_and_gateway5.jpg" alt="London" fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
                <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-20 transition-all duration-300"/>
                <div className="absolute bottom-4 left-4">
